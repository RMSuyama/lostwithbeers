...
export const CHAMPIONS = {
    ...
    shiryu: {
        ...
        basic: { range: 250, arc: 0.6, dmg: 51, ranged: true, proj: { maxPierce: 2 } },
    ...
    charles: {
        ...
        basic: { range: 350, arc: 0.3, dmg: 53, ranged: true, proj: { type: 'chain', bounce: 5 } },
    ...
    poisoncraft: {
        ...
        basic: { range: 250, arc: 0.5, dmg: 53, ranged: true, proj: { maxPierce: 3 } },
        skill: { name: 'Venom Nova', cost: 40, cd: 8000 },
        skill2: { name: 'Plague Bolt', cost: 10, cd: 3000 }
    },
    foxz: {
        name: 'Foxz', color: '#7e22ce', hp: 90, mana: 140,
        basic: { range: 300, arc: 0.4, dmg: 52, ranged: true, proj: { type: 'curve', curve: -1.5 } },
    ...
    dan: {
        ...
        basic: { range: 220, arc: 0.6, dmg: 50, ranged: true, proj: { type: 'boomerang' } },
    ...
    nadson: {
        ...
        basic: { range: 300, arc: 0.5, dmg: 51, ranged: true, proj: { type: 'curve', curve: 2.2 } },
    ...
    espirro: {
        ...
        basic: { range: 95, arc: 1.5, dmg: 57, kb: 35 },
